...
const ContactPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const contactMessage = formData.get('Message')?.trim();
    ...
    const data = { name, email, message: contactMessage };

    try {
      await apiClient.post(API_ENDPOINTS.contact, data);
      setMessage('Contact message sent successfully');
      navigate('/login');
    } catch (error) {
      setMessage(error.response?.data || 'An error occurred while sending the contact form');
    }
  };
          ...
          <div className="col-md-4 col-lg-4 col-sm-8 mx-auto">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form my-3">
                ...
                <textarea rows={5} className="form-control" id="Message" placeholder="Enter your message" name="Message" />
              </div>
